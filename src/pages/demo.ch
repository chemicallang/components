        ...
        <Tabs>
            ...
            <TabPanel style={active == 0 ? "" : "display:none;"}>
                <div class="todo-list">
                    {todos.map((todo, index) => (
                        <TodoCard 
                            cardStyle={todo.visible ? "" : "display:none;"} 
                            done={todo.done} 
                            title={todo.title} 
                            caption={todo.caption} 
                            note={todo.note} 
                            badgeLabel={todo.badgeLabel} 
                            accentStyle={todo.badgeTone == "accent" ? "" : "display:none;"} 
                            successStyle={todo.badgeTone == "success" ? "" : "display:none;"} 
                            chipAccentStyle={todo.badgeTone == "chipAccent" ? "" : "display:none;"} 
                            plainStyle={todo.badgeTone == "plain" ? "" : "display:none;"} 
                            captionStyle={todo.caption == "" ? "display:none;" : (todo.done ? "text-decoration:line-through;opacity:0.5;" : "")} 
                            noteStyle={todo.done ? "text-decoration:line-through;opacity:0.5;" : ""} 
            ...
            <TabPanel style={active == 1 ? "" : "display:none;"}>
                <div class="todo-list">
                    {todos.map((todo, index) => (
                        <TodoCard 
                            cardStyle={todo.visible && todo.today && !todo.done ? "" : "display:none;"} 
                            done={todo.done} 
                            title={todo.title} 
                            caption={todo.caption} 
                            note={todo.note} 
            ...
            <TabPanel style={active == 2 ? "" : "display:none;"}>
                <div class="todo-list">
                    {todos.map((todo, index) => (
                        <TodoCard 
                            cardStyle={todo.visible && todo.done ? "" : "display:none;"} 
                            done={todo.done} 
                            title={todo.title} 
                            caption={todo.caption} 
                            note={todo.note} 
